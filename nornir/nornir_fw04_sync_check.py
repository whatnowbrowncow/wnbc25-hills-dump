...
if __name__ == "__main__":
    ...
    #term = nr_devices.run(task=netmiko_send_command, command_string="terminal pager 0")
    acls = nr_devices.run(task=netmiko_send_command, command_string="show access-list | inc elements", use_genie=False, use_timing=True)
