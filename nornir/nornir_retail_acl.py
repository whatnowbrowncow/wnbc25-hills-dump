...
if __name__ == "__main__":
    ...
    print("Checking sub interface acls") 
    sub_acls = nr_devices.run(task=netmiko_send_command, command_string="show run | section include interface", enable=True,use_genie=True, use_timing=True)
    for device,details in sub_acls.items():
    ...
    sub_acls_parsed = rhf.get_sub_interface_acls(sub_acls)
