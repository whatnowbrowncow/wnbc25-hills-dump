...
datafile = open('/gitnet/ansible/script-outputs/dev/ld6-epgs/ld6-epg-query-data-2.txt', 'r')
    ...
    for aline in datafile:
        ...
        if tenant == "PTE":
            ...
            try:
                ...
                dev7File = open('/gitnet/ansible/script-outputs/dev/ld6-epgs/epg_query_parser_output_with_sp.yml', 'a')
                dev7File.write(f'''
  - app_prof: "{app_prof}"
    tenant: "{tenant}"
    vrf: "{vrf}"
