...
### Source SDDC URL's ###
domainurl = '%s/policy/api/v1/infra/domains' %(srevproxyurl)
defgroupsurl = '%s/policy/api/v1/infra/domains/default/groups' %(srevproxyurl)
...
#                else:
#                    mgw_rules[str(rule["sequence_number"])]["Source(s)"][group].append(str(group+"-cannot process group, check contents in GUI, may be empty"))
#                
...
#                else:
#                    mgw_rules[str(rule["sequence_number"])]["Destination(s)"][group].append(str(group+"-cannot process group, check contents in GUI, may be empty"))
...
#                else:
#                    cgw_rules[str(rule["sequence_number"])]["Source(s)"][group].append(str(group+"-cannot process group, check contents in GUI, may be empty"))
...
#                else:
#                    cgw_rules[str(rule["sequence_number"])]["Destination(s)"][group].append(str(group+"-cannot process group, check contents in GUI, may be empty"))
...
#                    else:
#                        dfw_rules[str(rule["sequence_number"])]["Source(s)"][group].append(str(group+"-cannot process group, check contents in GUI, may be empty"))            
#                else:
...
#                    else:
#                        dfw_rules[str(rule["sequence_number"])]["Destiantion(s)"][group].append(str(group+"-cannot process group, check contents in GUI, may be empty"))
#                else:
#                    print("??????????????????cant find this group1?????????????????")
#                    print(group)
#                    print(str(cmap["display_name"])+":"+str(rule["sequence_number"]))
