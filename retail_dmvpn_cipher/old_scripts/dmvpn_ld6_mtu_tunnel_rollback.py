...
if __name__ == "__main__":
    ...
    for device, data in combined_data['tunnel 12 pre-change'].items():
        ...
        dmvpnmtupretable.add_row(device,tu12state,eigrp_neighbour,profile_match,mtu_match,update)
    ...
    for device, data in device_facts.items():
        ...
        try:
            ...
            combined_data['tunnel 11 post-change'][device]['psk'] = spoke_tunnels_parsed[device]['Tunnel11']['mtu']
    ...
    for device, data in combined_data['tunnel 12 post-change'].items():
        ...
        if update_required == True:
            ...
            update = '[yellow]\u2717[/yellow]'
            devices_configured.append(device)
        dmvpnmtuposttable.add_row(device,tu12state,eigrp_neighbour,profile_match,mtu_match,update)
