...
if __name__ == "__main__":
    ...
    for device, data in combined_data['tunnel 12 pre-change'].items():
        ...
        if combined_data['tunnel 12 pre-change'][device]['profile'] == profile['name']:
            combined_data['tunnel 12 pre-change'][device]['profile_match'] = '[green]\u2713 New profile[/green]'
            profile_match = '[green]\u2713 New profile[/green]'
        else:
            combined_data['tunnel 12 pre-change'][device]['profile_match'] = '[red]\u2717 Old profile[/red]'
    ...
    with open('/dbdev/retail_dmvpn_cipher/psk_config_ld6.txt') as f:
    ...
    for device, data in combined_data['tunnel 12 post-change'].items():
        ...
        if combined_data['tunnel 12 post-change'][device]['profile'] == profile['name']:
            combined_data['tunnel 12 post-change'][device]['profile_match'] = '[green]\u2713 New profile[/green]'
            profile_match = '[green]\u2713 New profile[/green]'
        else:
            combined_data['tunnel 12 post-change'][device]['profile_match'] = '[red]\u2717 Old profile[/red]'
            profile_match = '[red]\u2717 Old profile[/red]'
            update_required = True
        if update_required == True:
