...
dmvpnpskpretable = Table(title='DMVPN SCC Tunnel 11 + PSK Pre change Summary',show_header=True, header_style="bold blue")
dmvpnpskpretable.add_column('Device',justify='center')
dmvpnpskpretable.add_column('Tunnel 11 UP',justify='center')
dmvpnpskpretable.add_column('EIGRP  neighbour 10.92.26.1',justify='center')
...
dmvpnpskposttable = Table(title='DMVPN SCC Tunnel 11 + PSK Post change Summary',show_header=True, header_style="bold blue")
dmvpnpskposttable.add_column('Device',justify='center')
dmvpnpskposttable.add_column('Tunnel 11 UP',justify='center')
dmvpnpskposttable.add_column('EIGRP  neighbour 10.92.26.1',justify='center')
...
dmvpnpskresultstable = Table(title='DMVPN SCC Tunnel 11 + PSK change results Summary',show_header=True, header_style="bold blue")
dmvpnpskresultstable.add_column('Device',justify='center')
dmvpnpskresultstable.add_column('Tunnel 11 UP pre/post',justify='center')
dmvpnpskresultstable.add_column('EIGRP nbr 10.92.26.1 up pre/post',justify='center')
...
if __name__ == "__main__":
    ...
    for device, data in combined_data['tunnel 11 pre-change'].items():
        ...
        dmvpnpskpretable.add_row(device,tu11state,eigrp_neighbour,profile_match,psk_match,update)
    ...
    with open('/dbdev/retail_dmvpn_cipher/psk_config_scc.txt') as f:
    ...
    for device, data in combined_data['tunnel 11 post-change'].items():
        ...
        if combined_data['tunnel 11 post-change'][device]['psk'] == new_psk:
            combined_data['tunnel 11 post-change'][device]['psk_match'] = '[green]\u2713 New PSK[/green]'
            psk_match = '[green]\u2713 New PSK[/green]'
        else:
            combined_data['tunnel 11 post-change'][device]['psk_match'] = '[red]\u2717 old PSK[/red]'
            psk_match = '[red]\u2717 old PSK[/red]'
            update_required = True
        ...
        if combined_data['tunnel 11 post-change'][device]['profile'] == profile['name']:
            combined_data['tunnel 11 post-change'][device]['profile_match'] = '[green]\u2713 New profile[/green]'
            profile_match = '[green]\u2713 New profile[/green]'
        else:
            combined_data['tunnel 11 post-change'][device]['profile_match'] = '[red]\u2717 Old profile[/red]'
            profile_match = '[red]\u2717 Old profile[/red]'
            update_required = True
        if update_required == True:
            ...
            update = '[yellow]\u2717[/yellow]'
            devices_configured.append(device)
        dmvpnpskposttable.add_row(device,tu11state,eigrp_neighbour,profile_match,psk_match,update)
    ...
    with open('/dbdev/retail_dmvpn_cipher/outputs/golden_tunnel_state/scc_pre_change_state.json') as file1:
