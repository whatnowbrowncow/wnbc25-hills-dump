...
if __name__ == "__main__":
    ...
    filepath1 = '/dbdev/retail_dmvpn_cipher/outputs/golden_tunnel_state/scc_pre_change_state.json'
    with open(filepath1, "w") as outfile: 
        json.dump(device_tunnels, outfile)

    with open(f'/dbdev/retail_dmvpn_cipher/outputs/golden_tunnel_state/scc_pre_change_state.pickle', 'wb') as file:
