...
if __name__ == "__main__":
    ...
    nr_devices = nr.filter(role="prod")
    ...
    versions_parsed = ohf.get_version(device_facts,1)
    
    ## put together a combined data dictionary of all the facts we have parsed
    combined_data = {}
    devices_with_errors = []
    for router,details in versions_parsed.items():
        #try:
...
## create various output files
    ...
    filepath1 = '/dbdev/oob/outputs/combined_data.json'
